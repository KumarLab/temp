 ...
 * Copyright by John Resig.
 * Released under the MIT and GPL licenses.
 */
(function(jQuery){
  // Here, Overriding the animation for all of these color styles...
	...
	function getColor(elem,attr){
		...
		do {
			...
			// Keep going until this script find an element that has color, or now hit the body...
	...
	// Some named colors to work with from Interface by Stefan Petre.
	// http://interface.eyecon.ro/
	var colors = {
		aqua:[0,255,255],		azure:[240,255,255],
		beige:[245,245,220],	black:[0,0,0],
		blue:[0,0,255],			brown:[165,42,42],
		cyan:[0,255,255],		darkblue:[0,0,139],
		darkcyan:[0,139,139],	darkgrey:[169,169,169],
		...
		olive:[128,128,0],		orange:[255,165,0],
		pink:[255,192,203],		purple:[128,0,128],
		violet:[128,0,128],		red:[255,0,0],
